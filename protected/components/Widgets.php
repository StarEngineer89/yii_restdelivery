...
class Widgets extends CApplicationComponent
{
 ...
 <?php echo Yii::t("default","View Map")?></a>
			   ...
			   <div class="search-wrapper rounded2">
			      <div class="inner">
			        ...
			        <form class="forms-search" id="forms-search" action="<?php echo baseUrl()."/store/searchArea"?>">
			          ...
			          <button type="submit" class="place_order green-button medium inline blocks">Search</button>
			        </form>
	...
	{		
        ...
        if ($is_commision){ 
             $enabled_sagepay=in_array("sagepay",(array)$paymentgateway)?true:false;        	
            $enabled_paypal=in_array("paypal",(array)$paymentgateway)?true:false; 
            $enabled_stripe=in_array("stripe",(array)$paymentgateway)?true:false; 
            $merchant_mercado_enabled=in_array("mercadopago",(array)$paymentgateway)?true:false; 
            $merchant_sisow_enabled=in_array("ide",(array)$paymentgateway)?true:false; 
        ...
        $merchant_switch_master_sap=Yii::app()->functions->getOption("merchant_switch_master_sap",$merchant_id);   
        if ( $merchant_switch_master_cod==2){
        	$merchant_disabled_cod="yes";
        }
        
         if ( $merchant_switch_master_sap==2){
        	$merchant_disabled_sap="yes";
        }
        ...
        ?>
         ...
         <?php if ($merchant_disabled_sap!="yes"):?>
         <div class="uk-form-row">
         <?php echo CHtml::radioButton('payment_opt',false,
         array('class'=>"payment_cod icheck payment_option",'value'=>'sap'))?>
         </div>
         
         <div class="uk-form-row change_wrap1">
        <div id="main">
      ...
      <form>
        ...
        <label><input type="checkbox" name="colorCheckbox" value="red"> Billing Address : (  ) Tick the checkbox to change your billing address</label>
         <div class="red box">
    ...
    <br/>  
        ...
        <!--<div id="submit-container">
         ...
         <?php if ($enabled_sagepay==TRUE):?>
         <div class="uk-form-row">
         
         <?php echo CHtml::radioButton('payment_opt',false,
         array('class'=>"icheck payment_option",'value'=>"sap"))?> <?php echo Yii::t("default","sagepay")?>
         </div>        
         <?php endif;?>
