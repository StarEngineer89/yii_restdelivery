<form class="uk-form uk-form-horizontal admin-settings-page forms" id="forms">
    ...
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Hide featured restaurant section (only on mobile)")?>?</label>
        <?php
        echo CHtml::checkBox('disabled_featured_merchant_mobile',getOptionA('disabled_featured_merchant_mobile')=="yes"?true:false,array(
            'class'=>"icheck",
            'value'=>"yes"
        ));
        ?>
    ...
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Hide Menu section in Mobile")?></label>
        <?php
        echo CHtml::checkBox('theme_hide_footer_section1_mobile',getOptionA('theme_hide_footer_section1_mobile')==2?true:false,array(
            'class'=>"icheck",
            'value'=>2
        ));
        ?>
    ...
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Hide Others section in Mobile")?></label>
        <?php
        echo CHtml::checkBox('theme_hide_footer_section2_mobile',getOptionA('theme_hide_footer_section2_mobile')==2?true:false,array(
            'class'=>"icheck",
            'value'=>2
        ));
        ?>
