...
<?php
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label"><?php echo Yii::t("default","Home Title Text on Mobile")?></label>
                    <?php
                    echo CHtml::textField('home_search_text_mobile',
                        Yii::app()->functions->getOptionAdmin('home_search_text_mobile'),
                        array(
                            'class'=>"uk-form-width-large",
                            'placeholder'=>t("ORDER FOOD")
                        ))
                    ?>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label"><?php echo Yii::t("default","Home SubTitle Text on Mobile")?></label>
                    <?php
                    echo CHtml::textField('home_search_subtext_mobile',
                        Yii::app()->functions->getOptionAdmin('home_search_subtext_mobile'),
                        array(
                            'class'=>"uk-form-width-large",
                            'placeholder'=>t("FROM YOUR LOCAL TAKEAWAYS")
                        ))
                    ?>
                </div>
