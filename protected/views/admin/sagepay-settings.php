...
<!--<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Enabled sagepay?")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Disabled sagepay")?>?</label>
  <?php 
  echo CHtml::checkBox('admin_enabled_paypal',
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","sagepay User")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","sagepay Password")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","sagepay Signature")?></label>
  <?php 
...
<hr>
<h3><?php echo t("Mobile sagepay Settings")?></h3>
