...
if(!isset($_GET['iframe'])) {
    if (getOptionA('disabled_subscription') == ""):
        ?>
    ...
    <div class="sections section-socialmedia  socialmedia-m">
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="float: none; margin: auto;">
                    <?php if ($social_flag <> 1): ?>
                        <div class="col-md-8 border">
                            <h2><?php echo t("Connect with us") ?></h2>

                            <div class="mytable social-wrap">
                                <?php if (!empty($google_page)): ?>
                                    <div class="mycol border">
                                        <a target="_blank" href="<?php echo FunctionsV3::prettyUrl($google_page) ?>"><i
                                ...
                                <?php if (!empty($twitter_page)): ?>
                                    <div class="mycol border">
                                        <a target="_blank" href="<?php echo FunctionsV3::prettyUrl($twitter_page) ?>"><i
                                ...
                                <?php if (!empty($fb_page)): ?>
                                    <div class="mycol border">
                                        <a target="_blank" href="<?php echo FunctionsV3::prettyUrl($fb_page) ?>"><i
                                ...
                                <?php if (!empty($intagram_page)): ?>
                                    <div class="mycol border">
                                        <a target="_blank" href="<?php echo FunctionsV3::prettyUrl($intagram_page) ?>"><i
                                ...
                                <?php if (!empty($youtube_url)): ?>
                                    <div class="mycol border">
                                        <a target="_blank" href="<?php echo FunctionsV3::prettyUrl($youtube_url) ?>"><i
    ...
    <div class="sections section-footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 border footer-menu">
                ...
                <div class="col-md-2 border footer-others">
                ...
                <?php if ($social_flag <> 1): ?>
                    <div class="col-md-2 border socialmedia-d">
                ...
                <div class="col-md-2 border">
                    <h2><img src="../assets/images/pyment-logo.jpg"></h2>
                </div>
            </div> <!--row-->
