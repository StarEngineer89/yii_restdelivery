...
debugger;
            ...
            var seconds = 60;
            var est_time = null;
            <?php if ($data['est_time']): ?>
            est_time = <?php echo $data['est_time'] ?>;
            <?php endif; ?>
            function secondPassed() {
                ...
                if (seconds == 0) {
                    ...
                    if (est_time == null || est_time == 0 || est_time == 1001) {
                        document.getElementById('countdown').innerHTML = "<br/><b><h3>Thank you for your order. Your order has been received and will be processed shortly.</b></h3>";
                    } else {
                        document.getElementById('countdown').innerHTML = "<br/><b><h3>Thank you for your order. Your order has been processed with a time of <a>" + est_time + "Minutes</a> selected by the shop.</b></h3>";
                    }
                } else {
                    seconds--;
                }
        ...
        <?php if ($ok==TRUE):?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-left">
                    <a class="btn btn-default" href="/profile?#order-history">Track Order</a>
                </div> <!--col-->
...
if (!in_array($data['order_id'],(array)$_SESSION['kr_receipt'])){
    if ($order_ok==true){
        ...
        if (isset($data['est_time']) && $data['est_time']) {
            $data['est_time'] = $data['est_time'] * 60;
        }
