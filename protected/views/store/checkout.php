     ...
     <!--LEFT CONTENT-->
	  ...
	  <div class="col-md-6 border" >
	    ...
	    <?php if ( $disabled_guest_checkout!="yes"):?>
		 ...
		 <h3><a href="<?php echo (!isset($_GET['iframe']))?$this->createUrl('/store/guestcheckout'):$this->createUrl('/store/guestcheckout?iframe=true');?>"
	               class="text-center block orange-text bottom20"><?php echo t("Continue as guest")?></a></h3>
		  <?php endif;?>
