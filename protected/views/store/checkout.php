            ...
            <div class="col-md-6 border" >
                ...
                <div class="box-grey rounded">
                    ...
                    <form id="forms" class="forms" method="POST">
                        ...
                        <?php
                        if(!isset($_GET['iframe'])) {
                            echo CHtml::hiddenField('redirect', Yii::app()->createUrl('/store/paymentoption'));
                        }
                        else {
                            CHtml::hiddenField('redirect', Yii::app()->createUrl('/store/paymentoption?iframe=true') );
                        }
                        ?>
                ...
                <div class="box-grey rounded top-line-green">
                    ...
                    <form id="form-signup" class="form-signup uk-panel uk-panel-box uk-form" method="POST">
                        ...
                        if(!isset($_GET['iframe'])){
                            ...
                            echo CHtml::hiddenField('redirect',Yii::app()->createUrl('/store/paymentoption?iframe=true'));
                        }
                        ?>
                        <?php FunctionsV3::addCsrfToken(false);?>
                        <?php
                        ...
                        <?php if ( $disabled_guest_checkout!="yes"):?>
                            <div class="section-label bottom20">
                                <a class="section-label-a">
                                    ...
                                    <span class="bold" style="background:#fff;">
                                        <!-- Replace the heading of Guest Checkout to Fast Checkout by CStar -->
                                        <?php /*echo t("Guest Checkout")*/?><!--</span>-->
                                        <?php echo t("Fast Checkout")?></span>
                                    <b></b>
                                </a>
                            </div>

                            <p style="margin-bottom:0;">
                                <!-- Replace the Guest/Fast checkout description by CStar -->
                                <?php /*echo t("Proceed to checkout, and you will have an option to create an account at the end.")*/?>
                                <?php echo t("Use fast checkout to proceed with your order quickly and fill your tummy.")?>
                            </p>
                            <h3>
                                <!--<a href="<?php /*echo (!isset($_GET['iframe']))?$this->createUrl('/store/guestcheckout'):$this->createUrl('/store/guestcheckout?iframe=true');*/?>"
