...
<div class="sections section-search-results">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 border search-left-content  fltr" id="mobile-search-filter">
                    ...
                    <div class="row infinite-container">
                        ...
                        <?php if ($data):?>
                            <?php foreach ($data['list'] as $val):?>
                                ...
                                /* Disabled -  By CStar on 2018-01-15 */
                                ...
                                $distance_type = $val['distance_type'];
                                if ($distance_type == 'M') {
                                    $distance_type = 'miles';
                                }
                                if ($distance_type == 'K') {
                                ...
                                if ($distance_type_orig == 'M') {
                                    $distance_type_orig = 'miles';
                                }
                                if ($distance_type_orig == 'K') {
                                    $distance_type_orig = 'kilometers';
                                }
                                if ($distance_type_orig == 'ft') {
                                    $distance_type_orig = 'ft';
                                }
                                /* Disabled - By CStar on 2018-01-15 */
                                ...
                                <?php
                                /*
                                 * Displaying only shops within distance small than merchant delivery distance setting
                                 *
                                 * Updated by CStar
                                 * */
