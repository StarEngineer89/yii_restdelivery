...
.logo-small, .logo-medium {
    ...
    @media only screen and (max-width: 1024px) and (min-width: 412px)  {
  ...
  .search-wraps.single-search, .parallax-search .search-wraps {
    ...
    margin-right: -9px;
     ...
     @media screen and (max-width: 1024px) and (min-width: 768px){
      .desktopsearch{ background-color: #ED1E79;
    margin-top: -6px;
    margin-bottom: ;
    min-width: 85px;
    padding: 9px;
    ...
    margin-right: -12px;
      ...
      .logo-small{ background-color: #ED1E79;
  margin-left:42%;
      }
     }
...
$placholder_search=Yii::t("default","Enter Full Postcode");
...
<video autoplay loop class="parallax-container parallax-home homaged">
  <source src="<?php echo assetsURL()."/images/bg.mov"?>" type="video/mp4">
</video>
...
<div class="sections section-how-it-works howitwork">
<div class="container">
  ...
  ?>   
    ...
    <div class="col-md-5 border-light ">
        ...
        <div class="col-md-3 col-sm-3">
           <img class="logo-small" src="<?php echo FunctionsV3::getMerchantLogo($val['merchant_id'],$val['logo']);?>" align="center"> 
        </div> <!--col-->
