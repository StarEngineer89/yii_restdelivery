        ...
        <div class="row">
            <div class="col-md-8 ">
                ...
                <div class="tabs-wrapper">
                    <ul id="tabs">
                        <li id="profile" class="<?php echo $tabs==""?"active":''?>">
                            <i class="ion-android-contact"></i> <span><?php echo t("Profile")?></span>
                        </li>

                        <li id="address-book" class="address-book <?php echo $tabs==2?"active":''?>" >
                            <i class="ion-ios-location-outline"></i> <span><?php echo t("Address Book")?></span>
                        </li>

                        <li id="order-history" class="order-history" ><i class="ion-ios-book-outline"></i>
                            <span><?php echo t("Order History")?></span>
                        </li>

                        <li id="booking-history" class="booking-history"><i class="ion-ios-bookmarks-outline"></i>
