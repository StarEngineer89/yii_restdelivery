...
$stores_pickup_custom_text=!empty($stores_pickup_custom_text)?(array)json_decode($stores_pickup_custom_text):false;
...
-->
            ...
            <div class="uk-form-row">
                <label class="uk-form-label">
                    <?php echo Yii::t("default","Store days(s) Pickup:")?>
                </label>
                <div class="clear"></div>
                    ...
                    <?php foreach ($days as $key=>$val):?>
                        <li>
                            <div class="uk-grid" >
                                ...
                                <div class="uk-width-1-6" style="width:5%;">
                                    <?php echo CHtml::checkBox('stores_pickup_day[]',
                                        in_array($key,(array)$stores_pickup_day)?true:false
                                        ,array('value'=>$key,'class'=>"icheck"))?>
                                </div>

                                <div class="uk-width-1-6" style="width:12%"><?php echo ucwords(Yii::app()->functions->translateDate($val));?></div>
                                <div class="uk-width-1-6" style="width:12%">
                                    <?php echo CHtml::textField("stores_pickup_starts[$key]",
                                        array_key_exists($key,(array)$stores_pickup_starts)?timeFormat($stores_pickup_starts[$key],true):""
                                        ,array('placeholder'=>Yii::t("default","Start"),'class'=>"timepick"));?>
                                </div>

                                <div class="uk-width-1-6" style="width:5%;"><?php echo Yii::t("default","To")?></div>
                                <div class="uk-width-1-6" style="width:12%">
                                    <?php echo CHtml::textField("stores_pickup_ends[$key]",
                                        array_key_exists($key,(array)$stores_pickup_ends)?timeFormat($stores_pickup_ends[$key],true):""
                                        ,array('placeholder'=>Yii::t("default","End"),'class'=>"timepick"));?>
                                </div>
                                ...
                                <div class="uk-width-1-6" style="width:12%">
                                    <?php echo CHtml::textField("stores_pickup_pm_start[$key]",
                                        array_key_exists($key,(array)$stores_pickup_pm_start)?timeFormat($stores_pickup_pm_start[$key],true):""
                                        ,array('placeholder'=>Yii::t("default","Start"),'class'=>"timepick"));?>
                                </div>
                                <div class="uk-width-1-6" style="width:5%;"><?php echo Yii::t("default","To")?></div>
                                <div class="uk-width-1-6" style="width:12%">
                                    <?php echo CHtml::textField("stores_pickup_pm_ends[$key]",
                                        array_key_exists($key,(array)$stores_pickup_pm_ends)?timeFormat($stores_pickup_pm_ends[$key],true):""
                                        ,array('placeholder'=>Yii::t("default","End"),'class'=>"timepick"));?>
                                </div>

                                <div class="uk-width-1-6" style="width:12%">
                                    <?php echo CHtml::textField("stores_pickup_custom_text[$key]",
                                        array_key_exists($key,(array)$stores_pickup_custom_text)?$stores_pickup_custom_text[$key]:""
                                        ,array('placeholder'=>Yii::t("default","Custom text")));?>
                                </div>
                            </div>
                        </li>
