...
$patern.="|monerisinit|confirmorder|sapinit|sap3dsecure|rzrinit|rzrverify|acceptorder|declineorder|cart|restaurant";
...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=yummydev_yummytak_yumm001',
			'emulatePrepare'   => true,
			'username'         => 'yummydev_yummyta',
			'password'         => 'oTiR]mTl+Uwp',
			'charset'          => 'utf8',
			'tablePrefix'      => 'mt_',
	    ),
