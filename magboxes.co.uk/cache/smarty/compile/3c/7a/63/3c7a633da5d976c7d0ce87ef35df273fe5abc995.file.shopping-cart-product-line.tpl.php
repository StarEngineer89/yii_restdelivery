<?php /* Smarty version Smarty-3.1.19, created on 2017-07-27 23:07:58
         compiled from "/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62311009597a643e0ea198-82158607%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c7a633da5d976c7d0ce87ef35df273fe5abc995' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/shopping-cart-product-line.tpl',
      1 => 1497861880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62311009597a643e0ea198-82158607',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597a643e318236_05809528',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597a643e318236_05809528')) {function content_597a643e318236_05809528($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/modifier.replace.php';
?>
...
">
		<span class="price product-price" id="total_product_price_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
<?php if ($_smarty_tpl->tpl_vars['quantityDisplayed']->value>0) {?>_nocustom<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])) {?>_gift<?php }?>">
			<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])) {?>
