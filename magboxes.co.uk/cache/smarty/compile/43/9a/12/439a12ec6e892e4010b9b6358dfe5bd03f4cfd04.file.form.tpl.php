<?php /* Smarty version Smarty-3.1.19, created on 2017-11-04 18:24:06
         compiled from "/home4/yummytak/public_html/magboxes.co.uk/modules/ybc_megamenu/views/templates/admin/_configure//helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:187027150459fe05c6dbc076-02650570%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '439a12ec6e892e4010b9b6358dfe5bd03f4cfd04' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/modules/ybc_megamenu/views/templates/admin/_configure//helpers/form/form.tpl',
      1 => 1497861880,
      2 => 'file',
    ),
    'c0d36c645617fb56daf39709ab161a41810b9698' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/admin6232kmhrf/themes/default/template/helpers/form/form.tpl',
      1 => 1497797226,
      2 => 'file',
    ),
    '85e9521b5ee2ed2533c35dbe46ef5d45c1f9b214' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/admin6232kmhrf/themes/default/template/helpers/form/form_group.tpl',
      1 => 1497797227,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187027150459fe05c6dbc076-02650570',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59fe05c71a6789_26665112',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59fe05c71a6789_26665112')) {function content_59fe05c71a6789_26665112($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/function.counter.php';
?>
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']!='manufacturers'&&$_smarty_tpl->tpl_vars['input']->value['type']!='cms_pages'&&$_smarty_tpl->tpl_vars['input']->value['type']!='products_search'&&$_smarty_tpl->tpl_vars['input']->value['type']!='manufacturer_menu'&&$_smarty_tpl->tpl_vars['input']->value['type']!='cms_page_menu') {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '187027150459fe05c6dbc076-02650570');
content_59fe05c70baa28_93731685($_smarty_tpl);
...
<br />
    	...
    	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='file'&&isset($_smarty_tpl->tpl_vars['display_img']->value)&&$_smarty_tpl->tpl_vars['display_img']->value) {?>
            <label class="control-label col-lg-3" style="font-style: italic;"><?php echo smartyTranslate(array('s'=>'Uploaded image: ','mod'=>'ybc_megamenu'),$_smarty_tpl);?>
</label>
            <div class="col-lg-9">
        		<a  class="ybc_fancy" href="<?php echo $_smarty_tpl->tpl_vars['display_img']->value;?>
"><img title="<?php echo smartyTranslate(array('s'=>'Click to see full size image','mod'=>'ybc_megamenu'),$_smarty_tpl);?>
" style="display: inline-block; max-width: 200px;" src="<?php echo $_smarty_tpl->tpl_vars['display_img']->value;?>
" /></a>
                <?php if (isset($_smarty_tpl->tpl_vars['img_del_link']->value)&&$_smarty_tpl->tpl_vars['img_del_link']->value) {?>
                    <a onclick="return confirm('<?php echo smartyTranslate(array('s'=>'Do you want to delete this image?','mod'=>'ybc_megamenu'),$_smarty_tpl);?>
...
"><span style="color: #666"><i style="font-size: 20px;" class="process-icon-delete"></i></span></a>
    	...
    	<?php }?>
    <?php } else { ?>
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='manufacturers') {?>
            <div class="col-lg-9">
                <ul style="float: left; padding: 0; margin-top: 5px;">
                    <?php if ($_smarty_tpl->tpl_vars['input']->value['manufacturers']) {?>
                        <?php  $_smarty_tpl->tpl_vars['mnft'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['mnft']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['manufacturers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['mnft']->key => $_smarty_tpl->tpl_vars['mnft']->value) {
$_smarty_tpl->tpl_vars['mnft']->_loop = true;
?>
                            <li style="list-style: none;"><input <?php if (in_array($_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['input']->value['selected_mnfts'])) {?> checked="checked" <?php }?> style="margin: 2px 7px 0 5px; float: left;" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
" name="mnfts[]" id="ybc_mm_mnft_<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
" /><label for="ybc_mm_mnft_<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
"><?php echo $_smarty_tpl->tpl_vars['mnft']->value['name'];?>
</label></li>
                        <?php } ?>
                    <?php }?>
                </ul>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='manufacturer_menu') {?>
            <div class="col-lg-9">
                <ul style="float: left; padding: 0; margin-top: 5px;">
                    <?php if ($_smarty_tpl->tpl_vars['input']->value['manufacturers']) {?>
                        <?php  $_smarty_tpl->tpl_vars['mnft'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['mnft']->_loop = false;
...
$_smarty_tpl->tpl_vars['mnft']->_loop = true;
?>
                            <li style="list-style: none;"><input <?php if ($_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer']==$_smarty_tpl->tpl_vars['input']->value['selected_mnft']) {?> checked="checked" <?php }?> style="margin: 2px 7px 0 5px; float: left;" type="radio" value="<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
" name="id_manufacturer" id="ybc_mm_mnft_<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
" /><label for="ybc_mm_mnft_<?php echo $_smarty_tpl->tpl_vars['mnft']->value['id_manufacturer'];?>
"><?php echo $_smarty_tpl->tpl_vars['mnft']->value['name'];?>
</label></li>
                        <?php } ?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='cms_pages') {?>
            <div class="col-lg-9">
                <ul style="float: left; padding: 0; margin-top: 5px;">
                    <?php if ($_smarty_tpl->tpl_vars['input']->value['pages']) {?>
                        <?php  $_smarty_tpl->tpl_vars['page'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['page']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['pages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['page']->key => $_smarty_tpl->tpl_vars['page']->value) {
$_smarty_tpl->tpl_vars['page']->_loop = true;
?>
                            <li style="list-style: none;"><input <?php if (in_array($_smarty_tpl->tpl_vars['page']->value['id_cms'],$_smarty_tpl->tpl_vars['input']->value['selected_pages'])) {?> checked="checked" <?php }?>  style="margin: 2px 7px 0 5px; float: left;" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
" name="cms_pages[]" id="ybc_mm_cms_<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
" /><label for="ybc_mm_cms_<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
"><?php echo $_smarty_tpl->tpl_vars['page']->value['meta_title'];?>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='cms_page_menu') {?>
            <div class="col-lg-9">
                <ul style="float: left; padding: 0; margin-top: 5px;">
                    <?php if ($_smarty_tpl->tpl_vars['input']->value['pages']) {?>
                        <?php  $_smarty_tpl->tpl_vars['page'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['page']->_loop = false;
...
$_smarty_tpl->tpl_vars['page']->_loop = true;
?>
                            <li style="list-style: none;"><input <?php if ($_smarty_tpl->tpl_vars['page']->value['id_cms']==$_smarty_tpl->tpl_vars['input']->value['selected_page']) {?> checked="checked" <?php }?>  style="margin: 2px 7px 0 5px; float: left;" type="radio" value="<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
" name="id_cms" id="ybc_mm_cms_<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
" /><label for="ybc_mm_cms_<?php echo $_smarty_tpl->tpl_vars['page']->value['id_cms'];?>
"><?php echo $_smarty_tpl->tpl_vars['page']->value['meta_title'];?>
</label></li>
                        <?php } ?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='products_search') {?>
            <div class="col-lg-9">
                <div id="ajax_choose_product">
                    <input type="hidden" name="inputAccessories" id="inputAccessories" value="<?php if ($_smarty_tpl->tpl_vars['input']->value['selected_products']) {?><?php  $_smarty_tpl->tpl_vars['accessory'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['accessory']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['selected_products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['accessory']->key => $_smarty_tpl->tpl_vars['accessory']->value) {
$_smarty_tpl->tpl_vars['accessory']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['accessory']->value['id_product'];?>
-<?php } ?><?php }?>" />
			        <input type="hidden" name="nameAccessories" id="nameAccessories" value="<?php if ($_smarty_tpl->tpl_vars['input']->value['selected_products']) {?><?php  $_smarty_tpl->tpl_vars['accessory'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['accessory']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['selected_products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['accessory']->key => $_smarty_tpl->tpl_vars['accessory']->value) {
$_smarty_tpl->tpl_vars['accessory']->_loop = true;
...
?>
                    			<div class="form-control-static">
                    				<button type="button" class="btn btn-default" onclick="ybcDelAccessory(<?php echo $_smarty_tpl->tpl_vars['accessory']->value['id_product'];?>
);" name="<?php echo $_smarty_tpl->tpl_vars['accessory']->value['id_product'];?>
">
...
"><i class="process-icon-cancel"></i><?php echo smartyTranslate(array('s'=>'Back','mod'=>'ybc_megamenu'),$_smarty_tpl);?>
</a>
            <?php }?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-11-04 18:24:07
         compiled from "/home4/yummytak/public_html/magboxes.co.uk/admin6232kmhrf/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59fe05c70baa28_93731685')) {function content_59fe05c70baa28_93731685($_smarty_tpl) {?>
