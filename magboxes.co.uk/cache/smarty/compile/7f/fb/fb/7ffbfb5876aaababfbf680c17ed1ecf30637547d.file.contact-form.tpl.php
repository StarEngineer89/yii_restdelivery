<?php /* Smarty version Smarty-3.1.19, created on 2017-07-28 06:40:49
         compiled from "/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1702904843597ace61149776-62578600%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ffbfb5876aaababfbf680c17ed1ecf30637547d' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/contact-form.tpl',
      1 => 1497861880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1702904843597ace61149776-62578600',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597ace6159a0e6_90786571',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597ace6159a0e6_90786571')) {function content_597ace6159a0e6_90786571($_smarty_tpl) {?>
...
<?php } else { ?>
	<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./errors.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
        ...
        <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_FORM_LAYOUT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_FORM_LAYOUT']=='layout2') {?>
                        <!--  Contact form (Layout 2)  -->
                    	<form action="<?php echo $_smarty_tpl->tpl_vars['request_uri']->value;?>
" method="post" class="contact-form-box contact-form-box-layout-2" enctype="multipart/form-data">
                    		<div>
                                <div class="row">
                    			<div class="clearfix">
                                    <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']) {?>
                                    ...
                                    <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT']) {?>
                                        <div class="col-xs-12 col-sm-6 contact_infor">
                                            <p><?php echo $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'];?>
</p>
                                                ...
                                                <ul class="contact_store_information_list">
                                                    <li class="contact_store_information_item">
                                                        ...
                                                        <div class="contact_store_information_right">
                                                            ...
                                                            <?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_COMPANY'])&&$_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_COMPANY'])) {?>
                                                                <div class="content">
                                                                    <?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_COMPANY'];?>
,<?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_ADDRESS'];?>
                                                    ...
                                                    <li class="contact_store_information_item">
                                                        ...
                                                        <div class="contact_store_information_right">
                                                            <label><?php echo smartyTranslate(array('s'=>'Phone:'),$_smarty_tpl);?>
</label>
                                                            <?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_PHONE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_PHONE'])) {?>
                                                                <div class="content">
                                                                    <?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_PHONE'];?>
,<?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_PHONE'];?>
                                                    ...
                                                    <li class="contact_store_information_item">
                                                        ...
                                                        <div class="contact_store_information_right">
                                                            ...
                                                            <?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_EMAIL'])&&$_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_EMAIL'])) {?>
                                                                <div class="content">
                                                                    <?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_EMAIL'];?>
...
<?php } else { ?>2000000<?php }?>" />
                    					...
                    					<div class="form-group message_contact">
                    						...
                    						<textarea class="form-control" id="message" placeholder="<?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
" name="message"><?php if (isset($_smarty_tpl->tpl_vars['message']->value)) {?><?php echo stripslashes(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value, ENT_QUOTES, 'UTF-8', true));?>
<?php }?></textarea>
                    					</div>
                                        <div class="submit">
                            				<button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-default button-medium"><span><?php echo smartyTranslate(array('s'=>'Send Email'),$_smarty_tpl);?>
</span></button>
                            			</div>
                    				</div>
                    			</div>
        ...
        <?php } elseif (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_FORM_LAYOUT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_FORM_LAYOUT']=='layout3') {?>
            <!--  Contact form (Layout 3)  -->
        	<form action="<?php echo $_smarty_tpl->tpl_vars['request_uri']->value;?>
" method="post" class="contact-form-box contact-form-box-layout-3" enctype="multipart/form-data">
        		<div>
                    <div class="row">
        			<div class="clearfix">
                        <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT']) {?>
                            <div class="col-xs-12<?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']) {?> col-sm-12 col-md-4<?php } else { ?> col-sm-6<?php }?> contact_infor">
                                <p><?php echo $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'];?>
</p>
                                <div class="contact_store_information">
                                    <ul class="contact_store_information_list">
...
,<?php echo $_smarty_tpl->tpl_vars['tc_config']->value['BLOCKCONTACTINFOS_PHONE'];?>
                        ...
                        <?php }?>
                        <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']) {?>
                            <div class="col-xs-12<?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT']) {?> col-sm-6 col-md-4 ybc_delay03<?php } else { ?> col-sm-6 ybc_delay03<?php }?> embe_map_contact">
                                <?php echo $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'];?>

                            </div>
                        <?php }?>
                        
        				<div class="col-xs-12<?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&(isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])) {?> col-sm-6 col-md-4 ybc_delay06<?php } elseif ((($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']==''&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])||($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT']==''))) {?> col-sm-6 ybc_delay03 <?php } elseif ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']==''&&isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONTACT_PAGE_TEXT']=='')) {?> col-sm-12<?php }?>">
        					<div class="form-group selector1">
        						<label for="id_contact"><?php echo smartyTranslate(array('s'=>'Subject Heading'),$_smarty_tpl);?>
</label>
        					<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['id_contact'])&&$_smarty_tpl->tpl_vars['customerThread']->value['id_contact']&&count($_smarty_tpl->tpl_vars['contacts']->value)) {?>
...
" method="post" class="contact-form-box" enctype="multipart/form-data">
        		<div>
        			...
        			<div class="clearfix">
        				...
        				<div class="col-xs-12<?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_GOOGLE_MAP_EMBED_CODE']) {?> ybc_delay03 col-md-6<?php }?>">
        					<div class="form-group selector1">
        						<label for="id_contact"><?php echo smartyTranslate(array('s'=>'Subject Heading'),$_smarty_tpl);?>
</label>
        					<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['id_contact'])&&$_smarty_tpl->tpl_vars['customerThread']->value['id_contact']&&count($_smarty_tpl->tpl_vars['contacts']->value)) {?>
