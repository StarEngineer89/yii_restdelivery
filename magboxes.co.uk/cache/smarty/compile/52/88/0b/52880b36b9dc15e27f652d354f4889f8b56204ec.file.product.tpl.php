<?php /* Smarty version Smarty-3.1.19, created on 2017-07-27 16:52:51
         compiled from "/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1547065753597a0c53508cb4-23844966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52880b36b9dc15e27f652d354f4889f8b56204ec' => 
    array (
      0 => '/home4/yummytak/public_html/magboxes.co.uk/themes/probusiness/product.tpl',
      1 => 1497861880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1547065753597a0c53508cb4-23844966',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597a0c53cfa215_32899417',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597a0c53cfa215_32899417')) {function content_597a0c53cfa215_32899417($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home4/yummytak/public_html/magboxes.co.uk/tools/smarty/plugins/function.counter.php';
?>
...
<?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_LAYOUT'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_LAYOUT']=='layout2') {?>
    <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./sub/product/product-layout2.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" data-id="resetImages">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			...
			<h1 itemprop="name" class=""><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
...
<?php }?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_REF'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_REF']) {?>
...
<?php }?></span>
            ...
            <?php }?>
            <div class="clearfix"></div>
            <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONDITION'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_CONDITION']) {?>
...
<span id="old_price_display"><span class="old-price product-price"><?php if ($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value)),$_smarty_tpl);?>
...
<?php }?></span>
			...
			<div id="oosHook"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>0) {?> style="display: none;"<?php }?>>
    			...
    			<form id="buy_block" class="<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0) {?> hidden<?php }?>" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart'), ENT_QUOTES, 'UTF-8', true);?>
" method="post">
    				<!-- hidden datas -->
    				<p class="hidden">
...
?>
    									<?php if (count($_smarty_tpl->tpl_vars['group']->value['attributes'])) {?>
    										<fieldset class="attribute_fieldset">
    											<label class="attribute_label<?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']=='color') {?> attribute_label_color<?php }?>" <?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']!='color'&&$_smarty_tpl->tpl_vars['group']->value['group_type']!='radio') {?>for="group_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute_group']->value);?>
...
"  class="color_pick color_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> selected<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['img_color_exists']->value&&isset($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'])&&$_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value']) {?> style="background:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'], ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked="checked"<?php }?> />
    						...
    						<?php }?>
                            <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_QTY'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_PRODUCT_QTY']) {?>
...
<?php }?></span>
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
    			...
    			<?php }?>
                <?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
                    <?php if (((isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)||($_smarty_tpl->tpl_vars['HOOK_EXTRA_LEFT']->value)||(isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_USEFUL_LINK'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_USEFUL_LINK']))) {?>
                        <ul class="box-sharing-button">
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_USEFUL_LINK'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_USEFUL_LINK']) {?>
                                <li class="print">
            						<a href="javascript:print();"><?php echo smartyTranslate(array('s'=>'Print'),$_smarty_tpl);?>
</a>
            					</li>  
                            <?php }?>
                        </ul>
                    <?php }?>
                    <?php if (((isset($_smarty_tpl->tpl_vars['HOOK_EXTRA_RIGHT']->value)&&$_smarty_tpl->tpl_vars['HOOK_EXTRA_RIGHT']->value)||(isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_SOCIAL_SHARING'])&&$_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_SOCIAL_SHARING']))) {?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
                <li role="presentation" class="active">
                    <a href="#product_description" aria-controls="product_description" role="tab" data-toggle="tab">
                        <span><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</span>
                    </a>
                </li>
            <?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
                <li role="presentation">
                    <a href="#product_featured" aria-controls="product_featured" role="tab" data-toggle="tab">
                        <span><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</span>
                    </a>
                </li>
            <?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['attachments']->value)&&$_smarty_tpl->tpl_vars['attachments']->value) {?>
                <li role="presentation">
                    <a href="#product_download" aria-controls="product_download" role="tab" data-toggle="tab">
                        <span><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</span>
                    </a>
                </li>
            <?php }?>
            <?php if ((isset($_smarty_tpl->tpl_vars['quantity_discounts']->value)&&count($_smarty_tpl->tpl_vars['quantity_discounts']->value)>0)) {?>
                <li role="presentation">
                    <a href="#product_discount" aria-controls="product_discount" role="tab" data-toggle="tab">
                        <span><?php echo smartyTranslate(array('s'=>'Volume discounts'),$_smarty_tpl);?>
</span>
                    </a>
                </li>
            <?php }?>
          ...
          <div class="tab-content">
                <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
        			...
        			<section class="page-product-box tab-pane active" id="product_description">
        				<!-- full description -->
                        <h2 style="display:none"><?php echo smartyTranslate(array('s'=>'product description'),$_smarty_tpl);?>
</h2>
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
                    ...
                    <h2 style="display:none"><?php echo smartyTranslate(array('s'=>'product featured'),$_smarty_tpl);?>
</h2>
...
">
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['attachments']->value)&&$_smarty_tpl->tpl_vars['attachments']->value) {?>
                    ...
                    <h2 style="display:none"><?php echo smartyTranslate(array('s'=>'product download'),$_smarty_tpl);?>
</h2>
...
">
 ...
 (<?php echo Tools::formatBytes($_smarty_tpl->tpl_vars['attachment']->value['file_size'],2);?>
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['quantity_discounts']->value)&&count($_smarty_tpl->tpl_vars['quantity_discounts']->value)>0)) {?>
                    ...
                    <h2 style="display:none"><?php echo smartyTranslate(array('s'=>'product discount'),$_smarty_tpl);?>
</h2>
...
%
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?>
        			...
        			<section class="page-product-box" id="product_accessories">
                        <h2 class="title-home"><span><?php echo smartyTranslate(array('s'=>'accessories'),$_smarty_tpl);?>
</span></h2>
        				<div class="block products_block accessories-block clearfix">
        					<div class="block_content">
        						<ul id="bxslider_custom" class="bxslider2 accessories_slider product_list clearfix">
...
">
                                                        ...
                                                        <?php if (isset($_smarty_tpl->tpl_vars['comparator_max_item']->value)&&$_smarty_tpl->tpl_vars['comparator_max_item']->value) {?>
                                    						<div data-id-product="<?php echo $_smarty_tpl->tpl_vars['accessory']->value['id_product'];?>
" class="add_to_compare compare" title="<?php echo smartyTranslate(array('s'=>'Add to Compare','mod'=>'productscategory'),$_smarty_tpl);?>
">
                                    							<a class="add_compare" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
