...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
                    ...
                    {if isset($tc_config.BLOCKCONTACTINFOS_PHONE) && $tc_config.BLOCKCONTACTINFOS_PHONE != ''}
                        ...
                        <i class="fa fa-phone-square" aria-hidden="true"></i>
                            <div class="shop_text_nav_config">
                                <b>{$tc_config.BLOCKCONTACTINFOS_PHONE_TOP}</b><br />{l s='24/7 Online Support'}
                            </div>
                        </div>
                    {/if}
				</div>
	...
	<div class="columns-container">
        <div id="slider_row" class="{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'} slider_full{/if}">
