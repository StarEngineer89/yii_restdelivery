					...
					<div>
						...
						<p id="old_price"{if (!$product->specificPrice || !$product->specificPrice.reduction)} class="hidden"{/if}>{strip}
							{if $priceDisplay >= 0 && $priceDisplay <= 2}
								...
								<span id="old_price_display"><span class="old-price product-price">{if $productPriceWithoutReduction > $productPrice}{convertPrice price=$productPriceWithoutReduction|floatval}{/if}</span>{if $productPriceWithoutReduction > $productPrice && $tax_enabled && $display_tax_label == 1} {if $priceDisplay == 1}{l s='tax excl.'}{else}{l s='tax incl.'}{/if}{/if}</span>
							{/if}
						{/strip}</p>
            ...
            {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
                <li role="presentation">
                    <a href="#product_discount" aria-controls="product_discount" role="tab" data-toggle="tab">
                        <span>{l s='Volume discounts'}</span>
                    </a>
                </li>
            {/if}
            {$HOOK_PRODUCT_TAB}
		...
		{if isset($accessories) && $accessories}
			<!--Accessories -->
        			<section class="page-product-box" id="product_accessories">
                        <h2 class="title-home"><span>{l s='accessories'}</span></h2>
        										...
        										<div class="product-box-content product-container">
                                                        ...
                                                        <div class="product-image-container">
                                                            ...
                                                            <div class="button-container-product">
                                                                {if isset($quick_view) && $quick_view}
                                                					<a class="quick-view" title="{l s='Quick view'}" href="{$accessoryLink|escape:'html':'UTF-8'}" rel="{$accessoryLink|escape:'html':'UTF-8'}">
                                                    ...
                                                    <div class="box_button">
                                                        ...
                                                        {if isset($comparator_max_item) && $comparator_max_item}
                                    						<div data-id-product="{$accessory.id_product}" class="add_to_compare compare" title="{l s='Add to Compare' mod='productscategory'}">
                                    							<a class="add_compare" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}">
