...
<!-- Block search module TOP -->
    <div id="search_block_top" class="animated{if $tc_config.YBC_TC_LAYOUT == 'LAYOUT2'} fadeIn ybc_delay04 search_layout_2{elseif $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'} search_layout_3{else} search_layout_1{/if}">
