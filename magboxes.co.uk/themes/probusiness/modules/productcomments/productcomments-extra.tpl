...
*}
{if isset($tc_config.YBC_TC_PRODUCT_REVIEW) && $tc_config.YBC_TC_PRODUCT_REVIEW}
{if (!$content_only && (($nbComments == 0 && $too_early == false && ($is_logged || $allow_guests)) || ($nbComments != 0)))}

<li class="product_comments_block_extra no-print" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
