...
<div class="countdown-content">
    <h4 class="title-home"> <span>{$YBC_SHOPMSG_TITLE}</span></h4>
	...
	{/if}
            ...
            <div class="item" itemscope itemtype="https://schema.org/Product">
                ...
                {if $image}
                    <a class="img_prod" href="{$link->getProductLink($product)}" title="{$product->name|escape:'html':'UTF-8'}">                    
                ...
                <div class="box-price">
                    ...
                    {if $productPriceWithoutReduction > 0 && isset($product->specificPrice) && $product->specificPrice && isset($product->specificPrice.reduction) && $product->specificPrice.reduction > 0}
